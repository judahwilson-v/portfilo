...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ITS LOOP section */}
      <section id="its-loop-section" style={{ position: 'relative', width: '100%', height: 'clamp(300px, 40vh, 600px)', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#000', overflow: 'hidden' }}>
        <TextPressure
          text="ITS LOOP"
          flex={true}
          alpha={false}
